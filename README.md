...
* ### rm [путь]*
Удаляет элементы. Для удаления директорий спрашивает подтверждение.
**Флаг `-r`** - разрешает рекурсивное удаление директорий со всем содержимым. Без этого флага попытка копирования
